...
void Credits()
{
    ...
    fmt::print("  {1}{2}arg{3}parse{0} {4}::{0} {5}{7}Thanks to p-ranav {6}for this cool lib :>{0}\n", RESET, ORANGE, BOLD, GOLD, DARK_GRAY, GREEN, DARK_GREEN, ITALIC);
    fmt::print("  {1}{3}{4}json{0} {2}::{0} {5}{4}Thanks to Nlohmann for this epic lib!!{0}\n\n", RESET, BLUE, DARK_GRAY, BOLD, ITALIC, TEAL);
